...
int main(){
  ...
  cout << "\n";
  cout << "\n!!!! ATTENZIONE: 8 TEST DA SUPERARE !!!!";
  int nTest=1;
  
  {
    cout << "\n";
    cout << "\n-----------------------------------------";
    cout << "\n    TEST " << nTest << ": leavesToString(tr) ";
    cout << "\n-----------------------------------------";
    
    sreq=""; 
    cout << "\ncon tr uguale a:"<<endl;
    print(tr,"");
    sres =  leavesToString(tr);
    cout << "\nLa funzione ritorna "<<sres;
    bool ans=(sres==sreq);
    cout << "\nIl test e' superato? "
      "================================> "
         << siOrNo(ans)<<endl;
  ...
  tr6=new triNode{8,nullptr,nullptr,nullptr};
...

  {
    ...
    sreq="1 4 5 1 3 1 2 3 5 2 5 4 2 4 5 "; 
    cout << "\ncon tr uguale a:"<<endl;
    print(tr,"");
    sres =  leavesToString(tr);
    cout << "\nLa funzione ritorna "<<sres;
